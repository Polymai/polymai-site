(function () {
  ...
  const steps = [
    ...
    },
    {
      ...
      number: "03",
      label: "Build",
      title: "Run your coder",
      summary: "After Polymai prepares the task, run Codex, Claude Code, or another compatible coding agent.",
      artifact: "Focused code update",
      detail: "Polymai is coder-agnostic: the reviewed task and service boundaries exist before the coding agent starts.",
    ...
    },
    {
      ...
      artifact: "Preview and screenshots",
    ...
    },
    {
      ...
      number: "05",
      label: "Check",
      title: "Connect services and verify",
      summary: "Apply the service changes the app needs, then show anything still missing.",
      artifact: "Service setup and check report",
      detail: "Service provisioning runs in one click by default, test mode can run automatically, and live payment changes still need confirmation.",
    ...
    },
    {
      ...
      artifact: "Updated project memory",
