(function () {
  ...
  const steps = [
    ...
    },
    {
      ...
      summary: "Apply detected runtime changes, then surface missing setup and smoke-test blockers.",
      artifact: "Provisioning and readiness report",
      detail: "One-click provisioning is the default, test mode can run automatically, and live payment actions stay explicit.",
